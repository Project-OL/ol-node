-- DropForeignKey
ALTER TABLE "host_live_sessions" DROP CONSTRAINT "host_live_sessions_host_user_id_fkey";

-- DropIndex
DROP INDEX "agency_agent_applications_status_created_at_idx";
...
CREATE INDEX "point_ledger_entries_wallet_id_ref_id_idx" ON "point_ledger_entries"("wallet_id", "ref_id");
