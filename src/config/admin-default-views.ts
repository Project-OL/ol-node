...
export const DEFAULT_ADMIN_VIEWS: Record<string, string[]> = {
  ...
  UserDetailView: [
    ...
    'PATCH /admin/users/:id/kyc-contact',
    'POST /admin/users/:id/kyc/govt-id/upload-url',
    'POST /admin/users/:id/kyc/govt-id/confirm',
    'POST /admin/users/:id/agency-application/reopen',
  ...
  AgencyListView: [
    ...
    'PATCH /admin/agency/applications/:userId/kyc',
  ...
  AgencyDetailView: [
    ...
    'PATCH /admin/agency/:identifier/kyc-contact',
    'POST /admin/agency/:identifier/kyc/govt-id/upload-url',
    'POST /admin/agency/:identifier/kyc/govt-id/confirm',
  ...
  AgencyPayrollView: [
    ...
    'GET /admin/agency/withdrawal/:id',
    ...
    'POST /admin/agency/withdrawal/:id/proof-upload-url',
    'POST /admin/agency/withdrawal/:id/complete',
    'POST /admin/agency/withdrawal/:id/takeover',
  ...
  SystemSettingsView: [
    ...
    'GET /admin/system-settings/livestream-reward',
    'PUT /admin/system-settings/livestream-reward',
  ...
  CurrencyView: [
    ...
    'GET /admin/ledger/treasury-flows',
    'POST /admin/ledger/treasury-flows/classify',
    'GET /admin/currency/cash-journal',
    'POST /admin/currency/cash-journal',
    'GET /admin/users/search',
  ],
  AdminActivityView: [
