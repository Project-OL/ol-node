...
export const FACE_QUALITY_USER_MESSAGES: Record<FaceRegistrationErrorCode, string> = {
  ...
  FACE_QUALITY_MONOCHROME:
    'Black and white photos are not accepted. Please use a color photo.',
  ...
  FACE_QUALITY_CONTENT_POLICY:
    'Image violates our content policy and cannot be accepted.',
