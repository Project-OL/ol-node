...
export async function richTierRoutes(app: FastifyInstance) {
  ...
  app.get('/me', { preHandler: readPre }, async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      await richTierService.enqueueMonthlyRolloverMaster(body.year, body.month, body.force)
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      await richTierService.processMonthlyRolloverForUser(userId, body.year, body.month)
