  ...
  app.delete<{ Params: { messageId: string } }>(
    '/:messageId',
    {
      ...
      schema: {
        tags: ['Messages'],
        description:
          'Delete own message (only within the configured edit/delete window of sending)',
        params: {
          type: 'object',
          required: ['messageId'],
          properties: { messageId: { type: 'string', minLength: 1 } },
  ...
  app.patch<{
    ...
    '/:messageId',
    {
      ...
      schema: {
        tags: ['Messages'],
        description:
          'Edit own message content (only within the configured edit/delete window of sending)',
        params: {
          type: 'object',
          required: ['messageId'],
          properties: { messageId: { type: 'string', minLength: 1 } },
